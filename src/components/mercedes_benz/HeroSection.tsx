  ...
  return (
    <div className="relative bottom-17 w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 z-30">
        <h3 className="text-sm md:text-3xl text-gray-200 mb-2">$35,000</h3>
        <h1 className="text-4xl md:text-5xl mb-6">Mercedes-Benz, C Class</h1>
        <button className="bg-white text-black rounded-full px-6 py-2 text-sm">Learn More</button>
      </div>
