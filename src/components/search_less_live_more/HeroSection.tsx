...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-white bottom-17">
      <Image src="/image/Background+Overlay.png" alt="Car Image" fill className="object-cover" priority />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 z-20">
        ...
        <h1 className="text-4xl text-white md:text-6xl font-bold mb-6">Find Your Perfect Car</h1>
